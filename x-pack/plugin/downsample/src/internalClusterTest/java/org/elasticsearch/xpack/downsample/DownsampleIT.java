...
public class DownsampleIT extends DownsamplingIntegTestCase {
    ...
    public void testDownsampledIndexIgnoresIndexTemplate() throws Exception {
        String dataStreamName = "metrics-foo";
        // Set up template
        putTSDBIndexTemplate("my-template", List.of("metrics-foo"), null, """
            {
        ...
        // Set up template that matched downsampled indices
        CompressedXContent mappings = CompressedXContent.fromJSON("""
            {
              "properties": {
                "attributes": {
                  "type": "keyword"
        ...
        request.indexTemplate(
            ComposableIndexTemplate.builder()
                .indexPatterns(List.of(randomFrom("downsample-*", "do*", "*sample*")))
                .template(Template.builder().mappings(mappings))
