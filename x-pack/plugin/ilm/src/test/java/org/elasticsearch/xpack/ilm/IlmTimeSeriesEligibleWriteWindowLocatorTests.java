...
public class IlmTimeSeriesEligibleWriteWindowLocatorTests extends ESTestCase {
    ...
    public void testNoEligibleWriteWindowStart() {
        ...
        {
            ProjectMetadata project = ProjectMetadata.builder(randomProjectIdOrDefault()).build();
            assertThat(locator.eligibleWriteWindowStartFromPolicy("my-policy", project), equalTo(-1L));
        }

        // No ILM policy with the provided name
        {
            ProjectMetadata project = projectWithIlmMetadata(Map.of());
            assertThat(locator.eligibleWriteWindowStartFromPolicy("missing-policy", project), equalTo(-1L));
        }
    ...
    public void testEligibleWriteWindowStartReadOnlyActionInAPhase() {
        ...
        assertThat(locator.eligibleWriteWindowStartFromPolicy("my-policy", project), equalTo(age.millis()));
    }
    ...
    public void testEligibleWriteWindowStartReadOnlyActionInSecondPhase() {
        ...
        assertEquals(warmAge.millis(), locator.eligibleWriteWindowStartFromPolicy("my-policy", project));
    }
    ...
    public void testEligibleWriteWindowStartEarliestPhaseWins() {
        ...
        assertEquals(hotAge.millis(), locator.eligibleWriteWindowStartFromPolicy("my-policy", project));
    }
