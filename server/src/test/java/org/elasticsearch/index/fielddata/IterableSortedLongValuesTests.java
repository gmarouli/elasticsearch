...
public class IterableSortedLongValuesTests extends AbstractFieldDataTestCase {
    ...
    public void testNextDoubleValue() throws Exception {
        ...
        assertThat(values.nextDoubleValue(), equalTo(5.0));
        assertThat(values.nextDoubleValue(), equalTo(10.00));
    }
    ...
    private IterableSortedNumericValues initialise(String indexName) throws Exception {
        ...
        XContentBuilder doc = XContentFactory.jsonBuilder().startObject().startArray("field").value(5).value(10).endArray().endObject();
