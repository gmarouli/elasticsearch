                ...
                if (values.advanceExact(i)) {
                    ...
                    for (int j = 0; j < numValues; ++j) {
                        if (mode == MultiValueMode.SUM || mode == MultiValueMode.AVG) {
                            expected += values.nextLongValue();
                        } else if (mode == MultiValueMode.MIN) {
                            expected = Math.min(expected, values.nextLongValue());
                        } else if (mode == MultiValueMode.MAX) {
                            expected = Math.max(expected, values.nextLongValue());
                        }
                    }
                    if (mode == MultiValueMode.AVG) {
                        ...
                        if (numValues % 2 == 0) {
                            ...
                            expected = Math.round(((double) values.nextLongValue() + values.nextLongValue()) / 2.0);
                        } else {
